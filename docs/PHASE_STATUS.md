...
- 2026-09-06 — **A persistent navigation shell, a real desktop layout, and a
  ...
  world at both widths; **B** was chosen and the other two deleted. Nine rounds
  ...
  **What the reviews were worth, and what they could not reach.** The sweep
  ...
  Green on this machine: lint, typecheck, knip, 272 unit, 254 emulator,
  1038/1038 sweep at five widths, and 110/110 web e2e. **Not yet run on a device** — this
