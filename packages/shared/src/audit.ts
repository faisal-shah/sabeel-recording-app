 ...
 *
 * `courseId` is the scoping key: when an action belongs to a class, the entry
 ...
 * history within assigned courses".
 */
export interface AuditEntryDoc {
  ...
  action: string;
  /** Course this action belongs to, or null when it is not class-scoped. */
